...
public class AppConfigStorage {
    ...
    private final ArrayList<ChangedConfigListener> changedConfigListeners = new ArrayList<>();
                ...
                if (dotPos >= 0) {
                    ...
                    if (item != null) {
                        ...
                        if (addObject instanceof Boolean) {
                            item.putBoolean(keyName, (Boolean)addObject);
                        } else if (addObject instanceof Integer) {
                            item.putInt(keyName, (Integer)addObject);
                        } else if (addObject instanceof Long) {
                            item.putLong(keyName, (Long)addObject);
