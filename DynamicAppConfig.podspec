#
# Be sure to run `pod lib lint DynamicAppConfig.podspec' to ensure this is a
...
For example: be able to make one build with a build selector that contains development, test, acceptance and a production configuration. There would be no need to deliver multiple builds for each environment for testing, it can all be done from one build.
  ...
  s.homepage         = 'https://github.com/crescentflare/DynamicAppConfig'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Crescent Flare' => 'info@crescentflare.com' }
  s.source           = { :git => 'https://github.com/crescentflare/DynamicAppConfig.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'DynamicAppConfigIOS/DynamicAppConfig/Classes/**/*'
  
  s.resource_bundles = {
    'DynamicAppConfig' => ['DynamicAppConfigIOS/DynamicAppConfig/Localization/*.lproj', 'DynamicAppConfigIOS/DynamicAppConfig/Layout/*.xib']
  }
